...
Feature: deGov - home page teasers
  ...
  Scenario: Verify that "Teaser - Small Image" exists and contain needed elements
    ...
    And I should see exactly 13 instances of the element with the selector ".paragraph-node-reference-node-view-mode-small-image .paragraph__content .small-image"
  ...
  Scenario: Verify that "Teaser - Long Text" exists and contain needed elements
    ...
    And I should see exactly 13 instances of the element with the selector ".paragraph-node-reference-node-view-mode-long-text .paragraph__content .long-text"
  ...
  Scenario: Verify that "Teaser - Preview" exists and contain needed elements
    ...
    And I should see exactly 13 instances of the element with the selector ".paragraph-node-reference-node-view-mode-preview .paragraph__content .preview"
  ...
  Scenario: Verify that "Teaser - Slim" exists and contain needed elements
    ...
    And I should see exactly 13 instances of the element with the selector ".paragraph-node-reference-node-view-mode-slim .paragraph__content .slim"
