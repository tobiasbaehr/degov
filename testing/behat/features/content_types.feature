...
Feature: NRWGov content types
  Scenario: Checking available node content types
    ...
    And I should see text matching "Newsletter Issue"
    And I should see text matching "Pressemitteilung"
  ...
  Scenario: Content type normal_page has all required fields
    ...
    And I should see text matching "field_metatags"
  ...
  Scenario: Content type simplenews_issue has all required fields
    Given I am logged in as a user with the "administrator" role
    And I am on "/admin/structure/types/manage/simplenews_issue/fields"
    Then I should see text matching "field_section"
    And I should see text matching "field_simplenews_issue_week"
    And I should see text matching "simplenews_issue"
    And I should see text matching "body"
    And I should see text matching "field_simplenews_issue_more"

  Scenario: Content type press has all required fields
    Given I am logged in as a user with the "administrator" role
    And I am on "/admin/structure/types/manage/press/fields"
    Then I should see text matching "field_view_control"
    And I should see text matching "field_section"
    And I should see text matching "field_press_date"
    And I should see text matching "field_content_paragraphs"
    And I should see text matching "field_content_type"
    And I should see text matching "field_internal_title"
    And I should see text matching "field_header_paragraphs"
    And I should see text matching "field_metatags"
    And I should see text matching "field_tags"
    And I should see text matching "field_sidebar_right_paragraphs"
    And I should see text matching "field_social_media"
    And I should see text matching "field_topic"
    And I should see text matching "field_teaser_image"
    And I should see text matching "field_teaser_text"
    And I should see text matching "field_teaser_title"
    And I should see text matching "field_teaser_sub_title"
