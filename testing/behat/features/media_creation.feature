...
Feature: deGov - Media creation
  ...
  Scenario: I am creating a video upload media entity
    ...
    And I attach the file "/opt/atlassian/pipelines/agent/build/docroot/profiles/contrib/degov/modules/degov_demo_content/fixtures/bokeh-video-of-leaves.mp4" to "files[field_video_upload_mp4_0]"
    And I scroll to element with id "edit-submit"
    And I press button with label "Save" via translated text
