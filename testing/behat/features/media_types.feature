...
Feature: NRWGov media types
  Scenario: Checking available Media Types
    ...
    And I should see text matching "Instagramm"
    And I should see text matching "Kontakt"
    And I should see text matching "Person"
    And I should see text matching "Social-Media-Einbettung"
  ...
  Scenario: Media Type Sociel-Media Einbettung has all required fields
    Given I am logged in as a user with the "administrator" role
    And I am on "/admin/structure/media/manage/some_embed/fields"
    Then I should see text matching "field_some_embed_code"
    And I should see text matching "field_media_generic_7"
    And I should see text matching "field_include_search"
    And I should see text matching "field_social_media_source"
    And I should see text matching "field_media_in_library"
    And I should see text matching "field_tags"
    And I should see text matching "field_title"
