...
/**
 * Class ViewsSearchContent.
 *
 * @package Drupal\degov_theme\Preprocess
 */
class ViewsSearchContent implements ContainerInjectionInterface {
  ...
  public function preprocess(array &$vars, string $hook): void {
    ...
    $config = [];
    $block_id = 'search_api_sorts_block:views_page:search_content__page_1';
    ...
    $sorts_block = $plugin_block->build();
