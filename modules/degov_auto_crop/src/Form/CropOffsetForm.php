...
class CropOffsetForm extends CropTypeForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['offsets']['landscape'] = [
      '#type'        => 'details',
      '#title'       => t('Automatic offset (landscape images)'),
      '#description' => t('<p>On first upload of a file the crop frame will be placed automatically. Use these values to define offsets for the placement.</p><p>Example: if <code>top</code> is <code>2</code> and <code>bottom</code> is <code>1</code>, the crop will be placed twice as far from the top of the image as from the bottom.</p>'),
    ];
    $form['offsets']['portrait'] = [
      '#type'        => 'details',
      '#title'       => t('Automatic offset (portrait images)'),
      '#description' => t('<p>On first upload of a file the crop frame will be placed automatically. Use these values to define offsets for the placement.</p><p>Example: if <code>top</code> is <code>2</code> and <code>bottom</code> is <code>1</code>, the crop will be placed twice as far from the top of the image as from the bottom.</p>'),
    ];
    $form['offsets']['square'] = [
      '#type'        => 'details',
      '#title'       => t('Automatic offset (square images)'),
      '#description' => t('<p>On first upload of a file the crop frame will be placed automatically. Use these values to define offsets for the placement.</p><p>Example: if <code>top</code> is <code>2</code> and <code>bottom</code> is <code>1</code>, the crop will be placed twice as far from the top of the image as from the bottom.</p>'),
    ];
